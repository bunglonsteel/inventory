<div class="layout-page">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="container-breadcrumb my-2">
            <h3 class="fw-bold mb-1">Semua Supplier</h3>
            ...
            <div class="col-12 mt-4">
                ...
                <div class="card p-2 pt-3 p-md-3">
                    <div class="card-header p-0 pb-3 mb-3 d-flex align-items-center justify-content-between border-bottom">
                        <h5 class="mb-0 ms-2">Supplier Produk</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row g-2 g-md-3">
                    <div class="col-12">
                        ...
                        <input type="text" name="supplier" class="form-control" placeholder="Ketikan supplier">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Tipe Perusahaan <span class="text-danger">*</span></label>
                        <input type="text" name="company" class="form-control" placeholder="Tipe perusahaan">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Kontak</label>
                        <input type="tel" name="contact" class="form-control" placeholder="No. telepon">
                    </div>
                    <div class="col-12">
                        <label class="form-label">Alamat</label>
                        <textarea name="address" class="form-control" placeholder="Ketikan alamat"></textarea>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#add-action', function(e) {
            e.preventDefault();
            formModal('add', 'Tambah Supplier', 'Tambah')
        });

        $(document).on('click', '.edit', function(e) {
            e.preventDefault();
            formModal('edit', 'Edit Supplier', 'Simpan')
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>admin/supplier/get_supplier/" + $(this).data('id'),
                data: "csrf_token=" + csrf.attr('content'),
                dataType: "JSON",
                success: function(res) {
                    if (res.success == "true") {
                        $('input[name="target"]').val(res.data.supplier_id)
                        $('input[name="supplier"]').val(res.data.supplier_name)
            ...
            Swal.fire({
                html: `<span class="swalfire bg-soft-danger my-3">
                    ...
                    <div>
                        ...
                        <p class="fs-6 mt-2">Anda yakin ingin menghapus supplier ini?</p>
                    </div>`,
                customClass: {
                ...
                if (e.value) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>admin/supplier/action/delete",
        ...
        btnSave.click(function(e) {
            ...
            if (saveAction == "add") {
                var url = "<?= base_url() ?>admin/supplier/action/add";
            } else if (saveAction == "edit") {
                var url = "<?= base_url() ?>admin/supplier/action/edit";
            }
