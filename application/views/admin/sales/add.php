                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input id="invoice" class="form-control" type="text" name="inv" placeholder="Ketikan Nomor Invoice">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex">
                                    <select id="select-customer" class="form-select w-100" name="customer">
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="select-date" class="form-control" type="datetime-local" name="date" value="<?= date('Y-m-d\TH:i') ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-2 g-md-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-2 mb-md-0">
                                    ...
                                    <input type="number" id="discount-all" class="form-control" name="discount_all" value="0" min="0">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-2 mb-md-0">
                                    <label class="input-group-text">Rp.</label>
                                    <input type="number" id="shipping" class="form-control" name="shipping" value="0" min="0">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-lg-4">
                                ...
                                <div class="d-flex mb-2 mb-md-0">
                                    <select id="payment-method" class="form-select w-100" name="method_pay">
                            ...
                            <div class="col-md-4 col-lg-4">
                                ...
                                <div class="d-flex mb-2 mb-md-0">
                                    <select id="payment-status" class="form-select w-100" name="status_pay">
                                        <option value="" hidden>Choose</option>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 col-md-7 col-lg-8">
                                        ...
                                        <textarea class="form-control mb-3 mb-md-0" name="notes" rows="3" placeholder="Catatan"></textarea>
                                    </div>
                                    <div class="col-12 col-md-5 col-lg-4 align-self-end">
                                        ...
                                        <button type="reset" id="reset-form" class="btn btn-danger">
...
<script>
    $(document).ready(function() {
                ...
                $('#product-cart').append(`
                    <tr data-rowid="${e.rowid}">
                        ...
                        <td class="text-center">
                            <input class="form-control text-center" id="quantity" value="${e.qty}" type="text" style="width:60px;">
                        </td>
                        <td>
        ...
        $(document).on('submit', '#form-data', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>admin/sales/manual/add",
